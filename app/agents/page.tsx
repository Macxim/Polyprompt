    ...
    <>
      ...
      <div className="p-8 max-w-5xl mx-auto">
        ...
        {state.agents.length === 0 ? (
          <div className="glass-panel p-12 text-center rounded-2xl flex flex-col items-center justify-center min-h-[400px]">
             ...
             <h3 className="text-xl font-bold text-slate-800 mb-2">Build Your Dream Team</h3>
             <p className="text-slate-500 max-w-sm mb-8">
               Create specialized AI agents with unique personas to help you with different tasks.
             </p>
              <button
                onClick={() => {
                  dispatch({ type: "CLEAR_ACTIVE_AGENT" });
                ...
                className="bg-white border border-slate-200 hover:border-indigo-300 hover:text-indigo-600 text-slate-600 font-medium px-6 py-3 rounded-xl transition-all shadow-sm"
              >
