    ...
    <>
      ...
      <div className="flex flex-col min-h-screen relative">
        ...
        <div className="absolute top-4 right-4 z-20">
          {status === "loading" ? (
            <div className="h-9 w-20 bg-slate-100/50 rounded-lg animate-pulse" />
          ) : status === "authenticated" ? (
             <div className="flex items-center gap-2 bg-white/50 backdrop-blur-sm p-1.5 pr-3 rounded-full border border-slate-200/60 shadow-sm hover:bg-white hover:shadow-md transition-all">
                {session.user?.image ? (
            ...
            <Link
              href="/auth/signin"
              className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm border border-slate-200 text-slate-600 font-bold text-sm rounded-full shadow-sm hover:bg-white hover:text-indigo-600 hover:shadow-md transition-all"
            >
        ...
        {!state._hydrated ? (
          <div className="flex flex-col w-full animate-pulse">
            {/* Hero Skeleton */}
            <section className="relative pt-12 sm:pt-16 pb-12" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 3rem)' }}>
              <div className="max-w-4xl mx-auto px-8 text-center flex flex-col items-center">
                {/* Badge */}
                <div className="w-32 h-6 bg-slate-200 rounded-full mb-6"></div>

                {/* Title */}
                <div className="h-10 sm:h-14 w-3/4 max-w-lg bg-slate-200 rounded-xl mb-4"></div>
                <div className="h-10 sm:h-14 w-1/2 max-w-sm bg-slate-200 rounded-xl mb-8"></div>

                {/* Subtitle */}
                <div className="h-4 w-96 max-w-full bg-slate-100 rounded-full mb-12"></div>

                {/* Input Area */}
                <div className="w-full max-w-2xl bg-white rounded-2xl border border-slate-100 shadow-lg p-4 h-40 mb-6">
                   <div className="h-full bg-slate-50/50 rounded-xl"></div>
                </div>
              </div>
            </section>

             {/* Recent Conversations Skeleton */}
            <section className="py-8 px-8 max-w-4xl mx-auto w-full">
              <div className="mb-6">
              ...
              <div className="grid gap-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-24 bg-white border border-slate-100 rounded-2xl p-4 flex items-center justify-between">
                     <div className="space-y-3 w-full">
                        <div className="h-5 w-2/3 bg-slate-100 rounded-lg"></div>
          ...
          <>
            ...
            <section className="relative pt-12 sm:pt-16" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 3rem)' }}>
            ...
            {state.conversations.length === 0 && (
              <section className="bg-slate-50/50 py-10 px-8 mt-8">
