...
- "Should I learn X or Y?", "React vs Vue?", "Career change?"
...
export async function checkQuestionSafety(
  ...
  try {
    ...
    // If unsafe but no alternative provided, use default
    ...
    // On error, fail safe (assume safe to avoid blocking legitimate use)
